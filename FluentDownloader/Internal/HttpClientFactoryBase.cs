...
{
    internal abstract class HttpClientFactoryBase : IHttpClientFactory
    {
        ...
        public virtual HttpClient GetHttpClient(string url)
        {
            ...
            var safeClient = _clients.AddOrUpdate(
                GetCacheKey(url), Create, (u, client) => client.IsDisposed ? Create(u) : client);
        ...
        protected virtual IHttpClient Create(string url) => new InternalHttpClient(this, url);
